    ...
    >
      ...
      >
        ...
        <div className="hidden md:block flex-shrink-0">
          <a
            href="#admissions"
            className="inline-flex items-center px-4 py-2 bg-theme-red hover:bg-red-800 text-white text-sm font-semibold rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-red-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-theme-red"
          >
            Apply Now: 2026–27
          </a>
        </div>
